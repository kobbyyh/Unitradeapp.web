// Simple Notification Service for Unitrade
// Combines email notifications with in-app notifications
...
class SimpleNotificationService {
    ...
    async init() {
        try {
            ...
            // Fallback: try to initialize with basic Firebase
            this.initializeWithBasicFirebase();
        }
    }

    async initializeWithBasicFirebase() {
        try {
            // Basic Firebase initialization
            const { initializeApp } = await import('https://www.gstatic.com/firebasejs/10.7.1/firebase-app.js');
            const { getFirestore, collection, addDoc, query, where, getDocs, orderBy, limit } = await import('https://www.gstatic.com/firebasejs/10.7.1/firebase-firestore.js');
            
            // Use the same config as your existing Firebase setup
            ...
            console.log('Simple Notification Service initialized with basic Firebase');
        } catch (error) {
            console.error('Error initializing with basic Firebase:', error);
        }
    }
    ...
    async sendEmailNotification(orderData, sellerEmail) {
        try {
            ...
            // For now, show email preview (you can integrate with EmailJS later)
